...
import KnowledgeCenterWebinarsDetails from "@/components/knowledgecenterwebinars/knowledgecenterwebinars";
...
export default function UniversityAdmissionOverviewPage() {
  return (
    <main>
      ...
      <KnowledgeCenterWebinarsDetails />
      {/* <SuccessstoriesPage /> */}
      {/* <ErithProducts/> */}
      {/* <ContactForm /> */}
