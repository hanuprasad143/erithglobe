...
//     console.log(item);
//   }
//   const handleProductChange = (sizes: string[]) => console.log(sizes);
//   const handleSizeChange = (sizes: string[]) => console.log(sizes);
//   const handlePressureChange = (sizes: string[]) => console.log(sizes);
//   const handleTorqueChange = (sizes: string[]) => console.log(sizes);
//   const handleIndustryChange = (sizes: string[]) => console.log(sizes);
//   return (
...
//             <ShopFilterSidebar
//               onProductChnage={handleProductChange}
